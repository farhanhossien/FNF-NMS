...
- [x] **Phase 1: Core Router Setup** - Integrate MikroTik API/SNMP to monitor traffic and health.
- [x] **Phase 2: Fiber Monitoring Integration** - Integrate OLT SNMP to monitor ONU optical signals.
- [x] **Phase 3: Dashboard & Alerts** - Build the UI dashboard and Telegram alert system.
...
Plans:
- [x] 02-01: Implement OLT SNMP polling and threshold detection.
...
Plans:
- [x] 03-01: Implement Express Dashboard and Telegram alerting.
...
| 2. Fiber Monitoring Integration | 1/1 | Complete | 2026-05-19 |
| 3. Dashboard & Alerts | 1/1 | Complete | 2026-05-19 |
